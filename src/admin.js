...
// (ten sposób nie jest optymalny — lepsza była suma logiczna użyta w Baskecie — ale też często spotykany)
...
// ----- Funkcja, która pozwoli na dodawanie nowych produktów do oferty na podstawie danych wejściowych z formularza ------
...
const handleAddProductFormSubmit = event => {
        ...
        // wartość inputów formularza wyciągamy dopiero w momencie jego przesłania; żeby dostać się do wartości przekazanej przez użytkownika używamy właściwości /.value/
